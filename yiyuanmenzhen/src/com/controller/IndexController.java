...
public class IndexController {
	...
	@Resource
	private YishengxinxiServer yishengxinxiServer;
	//jixacxishxu3
...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		List<Yishengxinxi> syyishengxinxi1=yishengxinxiServer.getsyyishengxinxi1(null);
		//jixacxishxu4
	    ...
	    map.put("syyonghuzhuce1", syyonghuzhuce1);
		  map.put("syyishengxinxi1", syyishengxinxi1);
	    //jixacxishxu5
