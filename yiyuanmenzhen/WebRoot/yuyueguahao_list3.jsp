...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="yuyueguahaoList2.do" name="myform" method="post">
    ...
    <td>${u.guahaofei}</td>
    <td>${u.yonghuming}</td>
     <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh3.jsp?id=${u.id}&yuan=${u.issh}&tablename=yuyueguahao'"/></td>
		 ...
		 <c:if test="${page.page>1}">
              <a href="yuyueguahaoList2.do?page=1" >首页</a>
             <a href="yuyueguahaoList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="yuyueguahaoList2.do?page=${page.page+1 }">下一页</a>
			<a href="yuyueguahaoList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
