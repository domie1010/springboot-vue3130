...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addPaibanxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加排班信息</td>
						</tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var zuozhenriqiobj = document.getElementById("zuozhenriqi"); if(zuozhenriqiobj.value==""){document.getElementById("clabelzuozhenriqi").innerHTML="&nbsp;&nbsp;<font color=red>请输入坐诊日期</font>";return false;}else{document.getElementById("clabelzuozhenriqi").innerHTML="  "; } 	var zuozhenkeshiobj = document.getElementById("zuozhenkeshi"); if(zuozhenkeshiobj.value==""){document.getElementById("clabelzuozhenkeshi").innerHTML="&nbsp;&nbsp;<font color=red>请输入坐诊科室</font>";return false;}else{document.getElementById("clabelzuozhenkeshi").innerHTML="  "; } 	var keyuyuerenshuobj = document.getElementById("keyuyuerenshu"); if(keyuyuerenshuobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(keyuyuerenshuobj.value)){document.getElementById("clabelkeyuyuerenshu").innerHTML=""; }else{document.getElementById("clabelkeyuyuerenshu").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}      var shengyuyuyuerenshuobj = document.getElementById("shengyuyuyuerenshu"); if(shengyuyuyuerenshuobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(shengyuyuyuerenshuobj.value)){document.getElementById("clabelshengyuyuyuerenshu").innerHTML=""; }else{document.getElementById("clabelshengyuyuyuerenshu").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}      
