...
<form action="pbxxList.do" name="myform" method="post" style="width:100%">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.zuozhenriqi}</td>    <td>${u.zuozhenkeshi}</td>    <td>${u.keyuyuerenshu}</td>    <td>${u.shengyuyuyuerenshu}</td>    <td>${u.zhanghao}</td>    <td>${u.yishengxingming}</td>    <td>${u.zhicheng}</td>    <td>${u.yiling}</td>    <td>${u.keshi}</td>    
                              ...
                              <td align="center"><a href="pbxxDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="pbxxList.do?page=1" >首页</a>
             <a href="pbxxList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="pbxxList.do?page=${page.page+1 }">下一页</a>
			<a href="pbxxList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
